...
resource "aws_subnet" "public" {
  ...
  map_public_ip_on_launch                     = local.enable_ipv4 && var.network_public_enable_ipv4
  ...
  assign_ipv6_address_on_creation                = local.enable_ipv6 && var.network_public_enable_ipv6
